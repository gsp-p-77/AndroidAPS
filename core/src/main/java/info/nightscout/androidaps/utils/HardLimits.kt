...
class HardLimits @Inject constructor(
    ...
    companion object {
        ...
        val VERY_HARD_LIMIT_TEMP_MIN_BG = intArrayOf(35, 180)
        val VERY_HARD_LIMIT_TEMP_MAX_BG = intArrayOf(35, 270)
        val VERY_HARD_LIMIT_TEMP_TARGET_BG = intArrayOf(35, 200)
